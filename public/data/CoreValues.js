export const coreValues = [
  {
    question: "BE GENUINE",
    answer:
      "Honesty and sincerity is paramount. Without pioneering trust in this ‘space’ adoption of Web3 technologies and brands will waver and trickle at best. The word ‘genuine’ is in our name and at the forefront of our collective mind. We strive to be honest and we aim to earn the trust of holders and non-holders alike. GU will remain authentic and transparent by considering these principles throughout organisational processes, echoed throughout our guidelines and in every action we take. Genuineness results in loyalty, a healthy community and a vibrant social atmosphere.",
  },
  {
    question: "PROMOTE INCLUSIVITY",
    answer:
      "Genuine Undead welcomes all persons into our community, regardless of race, colour, religion, belief system, gender, gender expression, sexual orientation, age, nationality, ancestry, ability, financial status or any other personal characteristic used to divide us as a community. Genuine Undead aims to go beyond these discriminating variables; rather we encourage love, mutual respect, humility and dulling of self-ego.",
  },
  {
    question: "SAFEGUARDING DECENTRALISATION",
    answer:
      "Decentralization aims to empower the collective and enable the wider audience (community) to partake in governance. We understand the need for it and the importance of autonomy. At the same time we understand that decentralisation, from an organisational perspective comes with its own issues. GU aims to safeguard the values of decentralisation, in a way that has never been done before. This is done by creating a network of councils run by the community and employing web2 efficiency into a Decentralised mesh. By doing so, we are able to harness the potential of the collective by encouraging and cultivating the contributions from each and every member of the community, curating it and amplifying it with a common goal. Each member’s role is recognized and respected, allowing the power of all to harmonise – to become the work product of the project.",
  },
  {
