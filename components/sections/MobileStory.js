...
const MobileStory = ({ t }) => {
  return (
    <section className="min-h-[120vh] w-full flex flex-col lg:flex-row lg:gap-[2.5rem] border-b border-black dark:border-white overflow-hidden">
      <div
...
{
  /* <section className="w-full flex flex-col border-b border-black dark:border-white overflow-hidden lg:hidden">
  <div
    className={`w-full bg-[url('/images/background/boney-light.png')] dark:bg-[url('/images/background/boney.png')] bg-cover bg-center flex items-center justify-center flex-1`}
  >
    <img
      src="/images/gu/miner.png"
  ...
  <div className="w-full h-[40%] flex flex-col justify-center relative px-[1.6rem] pb-[100px] mt-[20px]">
    <MainHeaderWrapper>
      <span>
        {t("sHeading1")} <i>{t("sHeading1a")}</i>{" "}
      </span>
