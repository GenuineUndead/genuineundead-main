...
const Ethos = ({ t }) => {
  return (
    <section className="min-h-[110vh] lg:min-h-screen  w-full flex flex-col lg:flex-row lg:gap-[2.5rem] border-b border-t border-black dark:border-white overflow-hidden">
      <div
